...
| 1 | Data layer + repositories | ⬜ not started | |
| 1 | Cognito + Cedar authorizer | ⬜ | |
| 2 | Intake API + presigned uploads | ⬜ | |
| 2 | AI provider + triage pipeline | ⬜ | |
| 2 | Priority scoring | ⬜ | |
| 2 | Duplicate detection | ⬜ | |
| 3 | Routing engine | ⬜ | |
| 3 | SLA + sweeper + escalation | ⬜ | |
| 4 | Web app shell + submit (PWA) | ⬜ | |
| 4 | Queue + incident detail | ⬜ | |
| 4 | Dashboard + metrics | ⬜ | |
| 5 | Copilot agent | ⬜ | |
| 5 | Prevention agent | ⬜ | |
| 6 | SAM deploy + CloudFront | ⬜ | |
| 6 | Observability + budgets | ⬜ | |
| 7 | Demo mode + script | ⬜ | |
